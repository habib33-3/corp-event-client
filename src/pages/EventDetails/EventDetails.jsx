...
const EventDetails = () => {
  ...
  return (
    <div className="w-full lg:w-4/5 mx-auto lg:p-10 space-y-10 rounded-xl shadow-xl bg-stone-200">
      ...
      <div className="flex justify-between items-center text-3xl font-medium">
